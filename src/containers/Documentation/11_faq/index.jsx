        ...
        <Col md={12} lg={9} xl={9} sm={12} xs={12}>
          <Card className="card--not-full-height">
            <CardBody className="documentation__changelog">
              Please be careful when you follow the instruction.
              <br />
              <br />
              ...
              <br />
              <br />
              If you have an error like &quot;Error: Cannot find module &apos;module_name&apos;&quot; you need to check
              the stage with the installation of a libraries. This error means that the module is not installed.
            </CardBody>
          </Card>
        </Col>
      </Row>
